      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start mb-16">
          ...
          <div>
            ...
            {/* Foto placeholder */}
            <div className="relative w-full aspect-square rounded-xl overflow-hidden border border-dark-border bg-dark-card flex items-center justify-center group">
              <span className="text-gold font-black text-6xl tracking-wider transition-transform duration-500 group-hover:scale-110">AR</span>
            </div>
        ...
        <div className="max-w-2xl mx-auto">
          <p className="text-gold text-xs tracking-[4px] uppercase mb-4 text-center">
            Lo que dicen
          </p>
          ...
          <div className="bg-dark-card border border-dark-border rounded-xl p-6 md:p-8">
            ...
            <div className="flex flex-col items-center justify-center py-12 md:py-16 border border-dashed border-dark-border rounded-lg">
